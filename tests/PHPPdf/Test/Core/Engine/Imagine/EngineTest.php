...
class EngineTest extends TestCase
{
    ...
    {
        $image = $this->getMockBuilder('Imagine\Image\ImageInterface')->getMock();
    ...
    {
        $imagineImage = $this->getMockBuilder('Imagine\Image\ImageInterface')->getMock();
    ...
    public function createFont()
    {
        ...
        $size = 123;
        $imagineFont = $this->getMockBuilder('Imagine\Image\FontInterface')->getMock();
