...
class GraphicsContextTest extends TestCase
{
    ...
    {
        $this->drawer = $this->getMockBuilder('Imagine\Draw\DrawerInterface')->getMock();
        $this->image = $this->getMockBuilder('Imagine\Image\ImageInterface')->getMock();
    ...
    public function clipRectangle()
    {
        ...
        $rectangleImage = $this->getMockBuilder('Imagine\Image\ImageInterface')->getMock();
